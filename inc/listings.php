...
if(!is_admin())
{
	add_shortcode('LF-Listings','LF_listings');
}

function LF_listings($atts)
{
	...
	if ($listkey) {
		...
		if($propertyDetails->error==false){
			...
			<div class="LF-description">
				...
				<div class="LF-row">
					...
					<p>
						<img src="<?php echo plugins_url('LF-Listings/assets/images/realtor_logos.png');?>">
					</p>
					<h1>Building</h1>
		...
		function LF_pagination(){
			...
			getLFListings($page,$mainSearch,$municipality,$sale,$bedroom,$bathroom,$property_Type,$priceFrom,$priceTo,$waterFront,$sort,$offices,$agents,$openhouse,$slug);
